          ...
          {FEATURED_INVESTIGATIONS.map((i, idx) => (
            ...
            >
              ...
              <button
                ...
                className="relative flex flex-col justify-between h-full p-6 bg-transparent hover:bg-[color-mix(in_oklab,var(--accent)_2.5%,transparent)] transition-colors duration-300 ease-out text-left w-full cursor-pointer overflow-hidden z-10"
              >
                ...
                <div className="relative z-10 mt-auto pt-4 border-t border-border-dim flex items-center justify-between font-mono text-[10px] uppercase tracking-[0.25em]">
                  ...
                  <span className="text-[var(--accent)] group-hover:translate-x-1 transition-transform duration-200 ease-out transform-gpu">
                    VER WRITEUP →
                  </span>
                </div>
              </button>
            ...
            {INVESTIGATIONS.map((i) => (
              ...
              >
                <button
                  type="button"
                  onClick={() => openWriteup(i.id)}
                  className="group relative flex flex-col justify-between h-full p-6 rounded-xs bg-[color-mix(in_oklab,var(--surface)_94%,transparent)] border border-border-dim hover:border-[var(--accent)]/55 hover:bg-[color-mix(in_oklab,var(--accent)_2.5%,var(--surface))] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06),0_6px_24px_rgba(0,0,0,0.35)] hover:shadow-[inset_0_1px_0_0_rgba(59,130,246,0.18),0_8px_24px_-4px_rgba(0,0,0,0.5)] hover:z-10 transform-gpu backface-hidden will-change-transform active:scale-[0.985] active:duration-100 transition-all duration-300 ease-out text-left w-full cursor-pointer overflow-hidden"
                >
                  {/* Top ambient highlight line */}
                  ...
                  <div>
                    ...
                    <h3 className="font-display font-bold text-xl leading-snug tracking-tight text-foreground group-hover:text-[var(--accent)] transition-colors duration-200 mb-3">
                      {i.title}
                    </h3>
                    <div className="flex flex-wrap gap-1.5 mb-3.5 min-h-[22px]">
                      {i.categories.map((c) => (
          ...
          <div className="hidden md:block overflow-x-auto border border-border-dim">
            ...
            {INVESTIGATIONS.map((i) => (
              ...
              >
                ...
                <div className="font-display font-semibold text-foreground text-[15px] tracking-tight leading-snug pt-0.5 group-hover:text-[var(--accent)] transition-colors duration-200">
                  {i.title}
                </div>
                ...
                <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-[var(--accent)] opacity-0 max-md:opacity-100 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all duration-200 ease-out transform-gpu pt-0.5 text-right">
                  VER →
                </div>
              </button>
            ))}
            ...
            {INVESTIGATIONS.map((i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="min-w-0 flex-1 truncate font-display font-semibold text-[14px] tracking-tight text-foreground group-hover:text-[var(--accent)] transition-colors duration-200">
                    {i.title}
                  </span>
                  <span className="shrink-0 font-mono text-[9px] uppercase tracking-[0.2em] text-[var(--accent)] group-hover:translate-x-0.5 transition-transform duration-200 ease-out transform-gpu">
                    VER →
                  </span>
                </div>
