export function Footer() {
  return (
    <footer
      className="border-t border-border-dim bg-[var(--surface)]/30"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-[var(--muted-foreground)]">
            © 2026 Santiago Daniel Sandili
          </span>

          {/* Back to top */}
          <a
            href="#top"
            className="group inline-flex items-center gap-2 min-h-[44px] px-2 py-2.5 font-mono text-[10px] uppercase tracking-[0.25em] text-[var(--muted-foreground)] hover:text-[var(--accent)] transition-colors"
          >
